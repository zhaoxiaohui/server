...
connection.o: connection.hpp connection.cpp reply.hpp request.hpp request_parser.hpp request_handler.hpp log.hpp file_cache.hpp
...
file_cache.o: file_cache.hpp file_cache.cpp reply.hpp
	g++ -o file_cache.o -c file_cache.cpp
